		...
		*/
		return new function() {
			...
			this.draw = function() {
				...
				var	srcY = Math.round(Math.min(Math.max(0, this.center.y - (this.height/2)), this.buffer.height));
				...
				var	srcHeight = Math.round(Math.max(0, Math.min((this.buffer.height) - srcY, (this.height) - dstY)));
